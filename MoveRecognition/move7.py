...
while(True):
    ...
    if stDev > sdThresh:
            ...
            cv2.putText(frame2, "Motion - {}".format("Moving"), (70, 100), font, 1, (255, 0, 255), 1, cv2.LINE_AA)
            ...
            cv2.putText(frame2, "Motion - {}".format("Stopped moving"), (70, 100), font, 1, (255, 0, 255), 1, cv2.LINE_AA)
